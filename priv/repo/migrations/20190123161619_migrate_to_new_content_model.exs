defmodule TdDf.Repo.Migrations.MigrateToNewContentModel do
  ...
  defp add_variable_cardinality(%{"required" => true}=field), do: Map.put(field, "cardinality", "+")
  defp add_variable_cardinality(field), do: Map.put(field, "cardinality", "*")

  defp add_single_cardinality(%{"required" => true}=field), do: Map.put(field, "cardinality", "1")
